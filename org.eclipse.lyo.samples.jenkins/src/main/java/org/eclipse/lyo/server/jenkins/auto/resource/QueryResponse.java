...
/**
 * An OSLC query response for the Jenkins automation provider. We need our own
 * class since we can't use OSLC4J's Wink provider to marshal the response.
 *
 * @author Samuel Padgett <spadgett@us.ibm.com>
 */
@OslcNamespace(JenkinsAutoConstants.NAMESPACE)
@OslcResourceShape(title = "Jenkins Query Response", describes = "QueryResponse")
